<p align="center">
  <img src="images/voidfm-icon.png" alt="VoidFM icon" width="96">
</p>
...
<p align="center">
  <a href="images/VoidFM1.png">
    <img src="images/VoidFM1.png" alt="VoidFM main interface" width="900">
  </a>
</p>
...
<table>
  <tr>
    <td width="50%">
      ...
      <p>Use Plex libraries or local music sources inside a dedicated Windows music player.</p>
    </td>
    <td width="50%">
      <h3>🔀 Smarter Shuffle</h3>
      <p>Create shuffle profiles, reduce repeats, space out artists, and shape the queue.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>📀 Better Playlists</h3>
      <p>Create, edit, import, export, customize, recover, and build playlists with more control.</p>
    </td>
    <td width="50%">
      <h3>🚫 Blocks And Linked Songs</h3>
      <p>Block music you do not want in rotation, or link tracks that belong together, like intros, skits, transitions, and companion songs.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>🎚️ Playlist EQ</h3>
      <p>Give each playlist its own EQ settings so different styles can play the way they should.</p>
    </td>
    <td width="50%">
      <h3>🎛️ Loop Launchpad</h3>
      <p>Assign custom loops from a track and replay favorite sections in new sequences.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>🎤 Lyrics, Chords, And Loops</h3>
      <p>View lyrics, sync chords, pop out windows, loop sections, and use waveform tools.</p>
    </td>
    <td width="50%">
      <h3>🎚️ Playback Control</h3>
      <p>Use EQ presets, crossfade, soft skips, persistent queues, caching, and playback recovery.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3>🧰 Local And Recoverable</h3>
      <p>Keep playlists, settings, rules, history, metadata, and backups stored locally.</p>
    </td>
    <td width="50%">
      <h3>🖥️ Built For Windows</h3>
      <p>Launch VoidFM as its own desktop app with a custom window, icon, installer, and shortcuts.</p>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center" width="50%">
      ...
      <br>
      <sub>Focus on the current track, artwork, queue, and playback controls.</sub>
    </td>
    <td align="center" width="50%">
      <a href="images/VoidFM_CustomShuffle.png">
        <img src="images/VoidFM_CustomShuffle.png" alt="VoidFM Custom Shuffle" width="100%">
      </a>
      <br>
      <strong>Custom Shuffle</strong>
      <br>
      <sub>Build smarter shuffle profiles and control how your library flows.</sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <a href="images/VoidFM_Equalizer.png">
        <img src="images/VoidFM_Equalizer.png" alt="VoidFM Equalizer" width="100%">
      </a>
      <br>
      <strong>Equalizer</strong>
      <br>
      <sub>Tune playback with EQ controls, presets, and playlist-specific EQ settings.</sub>
    </td>
    <td align="center" width="50%">
      <a href="images/VoidFM_Looper.png">
        <img src="images/VoidFM_Looper.png" alt="VoidFM Looper" width="100%">
      </a>
      <br>
      <strong>Looper</strong>
      <br>
      <sub>Loop sections, place markers, assign loop pads, and replay exact parts of a track.</sub>
    </td>
  </tr>
  <tr>
    <td align="center" colspan="2">
      ...
      <br>
      <sub>A dedicated startup screen before jumping into your library.</sub>
    </td>
  </tr>
</table>
